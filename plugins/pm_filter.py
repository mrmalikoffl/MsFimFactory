...
async def cb_handler(client: Client, query: CallbackQuery):
        ...
        if chat_type == enums.ChatType.PRIVATE:
            ...
            if grpid is not None:
                ...
                try:
                    ...
                    return await query.answer('♥️ Love @Mr Malik ♥️')
            else:
                await query.message.edit_text(
                    "I'm not connected to any groups!\nCheck /connections or connect to any groups",
                    quote=True
                )
                return await query.answer('♥️ Thank You Mr Malik ♥️')
    ...
    await query.answer('♥️ Thank You Mr Malik ♥️')
...
async def advantage_spell_chok(msg):
    ...
    await msg.reply("Please check your spelling once again 🤦‍♀️... or \n Discuss your problem with our admin here 👉 & Copy Paste On Group",
                    reply_markup=InlineKeyboardMarkup(btn))
